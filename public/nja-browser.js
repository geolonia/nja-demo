(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var getChibans = function (pref, city, town) { return __awaiter(void 0, void 0, void 0, function () {
        var cacheKey, cache, chibansResp, chibans;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    cacheKey = pref + "-" + city + "-" + town;
                    cache = cachedChibans[cacheKey];
                    if (typeof cache !== 'undefined') {
                        return [2 /*return*/, cache];
                    }
                    return [4 /*yield*/, __internals.fetch([
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, chibansResp.json()];
                case 3:
                    chibans = (_b.sent());
                    return [3 /*break*/, 5];
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5:
                    chibans.sort(function (res1, res2) { return ("" + res2.banchi).length - ("" + res1.banchi).length; });
                    return [2 /*return*/, (cachedChibans[cacheKey] = chibans)];
            }
        });
    }); };
    ...
    var normalizeResidentialPart = function (addr, pref, city, town) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, gaikuListItem, residentials, chibans, match, gaiku_1, jyukyo, jyukyohyoji_1, residential, addr2, gaikuItem, banchi_1, chiban, addr2, addr2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), gaikuListItem = _a[0], residentials = _a[1], chibans = _a[2];
                    // 住居表示未整備かつ、地番情報もない
                    ...
                    if (match) {
                        ...
                        if (chiban) {
                            ...
                            return [2 /*return*/, {
                                    ...
                                    addr: addr2,
                                    lat: chiban.lat || (gaikuItem === null || gaikuItem === void 0 ? void 0 : gaikuItem.lat) || '',
                                    lng: chiban.lng || (gaikuItem === null || gaikuItem === void 0 ? void 0 : gaikuItem.lng) || '',
                                }];
                        }
                        if (gaikuItem) {
